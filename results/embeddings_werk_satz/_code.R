...
beep() #notification wenn alles durch ist 

#Einzelbeispiele Results - Histogramme
hist(em_dist_verwandlung$cos_dist, breaks = 100)
hist(em_dist_prozess$cos_dist, breaks = 100)
hist(em_dist_schloss$cos_dist, breaks = 100)
hist(em_dist_amerika$cos_dist, breaks = 100)
hist(em_dist_bahnwerterthiel$cos_dist, breaks = 100)
hist(em_dist_ketzervonsoana$cos_dist, breaks = 100)
hist(em_dist_gehuelfe$cos_dist, breaks = 100)
hist(em_dist_brennendesgeheimnis$cos_dist, breaks = 100)
hist(em_dist_dersaenger$cos_dist, breaks = 100)
hist(em_dist_derfallderuga$cos_dist, breaks = 100)
hist(em_dist_spaziergang$cos_dist, breaks = 100) 
